...
class ComponentSocket extends Thread {
    ...
    public static MsgEncoder encoder;
    ...
    public void run() {
        ...
        while(!killThread){
            try {
                ...
                encoder = new MsgEncoder(socket.getOutputStream());
                ...
                while(true){
                    ...
                    if (kvList.size() > 1) {
                        Log.e(MainActivity.TAG, "Romote Received raw: <" + kvList.encodedString() + ">");
