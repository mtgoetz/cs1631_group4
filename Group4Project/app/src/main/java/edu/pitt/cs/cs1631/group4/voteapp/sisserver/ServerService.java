...
import edu.pitt.cs.cs1631.group4.voteapp.MainActivity;
...
public class ServerService extends Service {
    ...
    public void startServer(final String p) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Message message = activityCallbacks.obtainMessage(MainActivity.DISPLAY_INFO);
    ...
    class SocketsThread implements Runnable {
        ...
        public void run() {
            try {
                ...
                Message message = activityCallbacks.obtainMessage(MainActivity.CLIENT_DISCONNECTED);
        ...
        private void processMessage(KeyValueList kvList) {
            ...
            switch (messageType) {
                ...
                case SISMessage.REGISER:
                    ...
                    int index = Components.componentList.indexOf(cmpt);
                    Components.componentList.get(index).setEncoder(this.msgEncoder);
                    Message message = activityCallbacks.obtainMessage(MainActivity.NEW_COMPONENT_REGISTERED);
                ...
                case SISMessage.CONNECT:
                    ...
                    if(Components.componentList.contains(cmpttmp)){
                        index = Components.componentList.indexOf(cmpttmp);
                        ...
                        Message messagetmp = activityCallbacks.obtainMessage(MainActivity.NEW_COMPONENT_CONNECTED);
                        ...
                        Message messagetmp = activityCallbacks.obtainMessage(MainActivity.UNREGISTERED_COMPONENT);
                        messagetmp.obj = connectionNumber + ":" +sender+":"+ ip + ":" + port;
                        activityCallbacks.sendMessage(messagetmp);
                    }
                    break;
